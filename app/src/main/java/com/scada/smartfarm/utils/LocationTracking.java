...
//                Toast.makeText(mContext, " ", Toast.LENGTH_SHORT).show();
    ...
    public void showSettingsAlert(Context applicationContext) {
        this.cantGetLocation = false;



        AlertDialog.Builder alertDialog = new AlertDialog.Builder(applicationContext);
